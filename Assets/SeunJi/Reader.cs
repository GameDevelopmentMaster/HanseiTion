...
public class Reader : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        recordFile = SoundManager.instance.curNotes[SoundManager.instance.Index];
    ...
    private void ReadAllLine()
    {
        ...
        CountManager.instance.totalNote = noteCount;
    }
    ...
    private void ProcessLine(string _line)
    {
        ...
        if (float.Parse(line[1]) > prevSens + 1.5)
        {
            ...
            {
                GameObject _note = Instantiate(note,GameObject.Find("NoteManager").transform);
                noteCount++;
